...
\تب به جای رها شدن\\
\تب[1] سنگین سنگین بر دوش می‌کشیم\\
\تب[1.5] بار دیگران را\\
\تب[2] به جای همراهی کردن‌شان!\\
\تب[2.5] عشق ما نیازمند رهایی است نه تصاحب\\
 \تب[3] در راه خویش ایثار باید نه انجام وظیفه...\\
\\
\تب[3] وقتی که مرگ ما را برباید - تو را و مرا -\\
\تب[2.5] نباید که درپایان راه‌مان\\
\تب[2] علامت سوالی برجای بماند\\
\تب[1.5] تنها نقطه‌ای ساده\\
\تب[1] همین وبس\\
\تب چرا که ما، درحیات کوتاه خویش\\
فرصت‌های بی شماری داریم که دریابیم‌شان...\\
